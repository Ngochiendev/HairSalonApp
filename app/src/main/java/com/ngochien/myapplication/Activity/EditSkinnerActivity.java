...
public class EditSkinnerActivity extends AppCompatActivity {
    ImageView imageView;
    EditText edtTitle;
    Button btnSave;
    Stylist item;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_skinner);
        init();
        intent();
        getData();
    ...
    private void EditStylist(){
        ...
        firestore.collection("Skinners").document(item.getId()).update(map).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
    ...
    private void openImagePicker(){
        TedBottomPicker.with(EditSkinnerActivity.this)
        ...
        uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
            ...
            public void onComplete(@NonNull Task<Uri> task) {
                if (task.isSuccessful()) {
                    ...
                    firestore.collection("Skinners").document(StylistId).update("image", imgUrl).addOnSuccessListener(new OnSuccessListener<Void>() {
                        @Override
                        public void onSuccess(Void aVoid) {
